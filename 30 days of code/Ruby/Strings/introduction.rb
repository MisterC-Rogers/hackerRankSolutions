# Numbers, boolean values and strings are some of the fundamental data types that we have explored in our previous challenges. 
# In this set of tutorials, we turn our attention to the data type referred to as String or Text literals.
...
# Any character outside the ASCII encoding set is restricted in C. How do we represent characters outside this range?
...
# Double quoted strings are more flexible, and they allow special escape sequences, e.g.\t, \n, which don't work with single quoted strings. 
# More importantly, they allow the embedding of arbitrary expressions. 
# When a string is created, the expression in the string is evaluated, converted to a string and inserted into the text in place of the expression. 
...
# The text of the string literal begins on the next line and continues until the text of the delimiter appears on a line by itself. 
