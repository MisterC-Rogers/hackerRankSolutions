...
hackerrank = {1 => 1, 2 => 4, 3 => 9, 4 => 16, 5 => 25, "A" => 100}

#hash params
# hackerrank.keep_if{| key, value | key.is_a? Integer && key.odd?} <<== this worked on hackerrank 
# hackerrank.keep_if{| key, value | key.is_a? Integer && key != even?} <<== this also worked on hankerrank
# When running the code here in VS in throws errors unsure why oh well 
